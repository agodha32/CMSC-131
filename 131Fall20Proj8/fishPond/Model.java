...
public class Model {
	...
	public boolean isSpaceAvailable(int r, int c) {
		...
		} else if (fishCheck == true) {

			return false;

		} else if (plantCheck == true) {
	...
	public Model (Model other) {
		...
		this.landscape = new boolean [other.landscape.length]
				[other.landscape[0].length];
		
		for(int a = 0; a < other.landscape.length; a++) {
			
			for(int b = 0; b < other.landscape[a].length; b++) {
				
				this.landscape[a][b] = other.landscape[a][b];
	...
	private boolean fishIsSurroundedByRocks(Fish f) {
			...
			return landscape[f.getRow() + 1][f.getCol()] == ROCK &&
	...
	public void turnFish() {
		...
		for (Fish x : fish) {
			...
			if(x.isAlive() == true) {
				...
				if (fishIsSurroundedByRocks(x) == true) {
				...
				} else if (x.getDirection() != Fish.UP &&
					...
					do {
						...
						if (x.getDirection() == Fish.UP) {
							...
							a = landscape[x.getRow() - 1][x.getCol()];
							...
							a = landscape[x.getRow()][x.getCol() - 1];
	...
	public void addFish(Fish f) {
		...
		if (landscape[f.getRow()][f.getCol()] == ROCK) {
			...
			for (Fish x : fish) {
				...
				if (x.getCol() == f.getCol() && x.getRow() == f.getRow()) {
