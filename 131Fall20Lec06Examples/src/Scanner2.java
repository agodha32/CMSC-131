...
public class Scanner2{
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Since you have read " + book + " " + 
		                    timesRead + " times,");
		System.out.println("and " + book + " weighs " + weight + 
				           " pounds,");
		System.out.println("you have read " + (timesRead * weight) + 
				           " pounds worth of " + book + ".");
