...
public class Restaurant {
	...
	public SortedListOfImmutables getMenu() {
		...
		SortedListOfImmutables copyofMenuList =  new 
				SortedListOfImmutables(this.menu); // make a copy
		
		return copyofMenuList;
	...
	public void addEntree(Entree entreeToAdd) {
		...
		menu.add(entreeToAdd); // add the entree
	...
	public SortedListOfImmutables getInventory() {
		...
		SortedListOfImmutables copyofInventoryList =  new 
				SortedListOfImmutables(this.inventory); //make copy
		
		return copyofInventoryList;
